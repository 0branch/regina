...
#
 ...
 40, 43,%s Argument %d muss ein einzelner nicht-alphanumerische Zeichen oder die Null-Zeichenfolge sein; gefunden "%s"|<bif>,<argnumber>,<value>
 40, 44,%s Argument %d, "%s", ist ein Format, mit dem Argument in %d angegebene Trenn unvereinbar|<bif>,<argnumber>,<value>,<argnumber>
...
#
P,  0,Fehler %d während des Ausführens von "%.*s", Zeile %d: %.*s
P,  1,Fehler %d.%d: %.*s
P,  2,Fehler %d während des Ausführens von "%.*s": %.*s
#P,  3,Kann die sprachspezifische Datei nicht öffnen: %s
#P,  4,Ungültige Anzahl von Meldungen in der sprachspezifischen Datei: %s
#P,  5,Kann von der sprachspezifischen Datei nicht lesen: %s
#P,  6,Text fehlt in der sprachspezifischen Datei: %s.mtb
#P,  7,Sprachspezifische Datei %s.mtb ist beschädigt
